...
#'
#' @details
#' #' The data for the ipeds tibble comes from 2013, so the many of the variables could be very very different due to inflation or changes in the educational system.
...
#'   \item{tuition}{double for the average annual cost of attendance (Tuition + Fees) in 2013 in tens of thousands of dollars}
#'   \item{grad_rate}{double for the graduation rate in 2013}
