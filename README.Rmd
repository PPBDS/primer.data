...
`PPBDS.data` provides the data and the tutorials used in *[Preceptor's Primer for Big Bayesian Data Science](https://davidkane9.github.io/PPBDS/)*, the textbook used in [Gov 50: Data](https://www.davidkane.info/files/gov_50_fall_2020.html) at Harvard University. 
